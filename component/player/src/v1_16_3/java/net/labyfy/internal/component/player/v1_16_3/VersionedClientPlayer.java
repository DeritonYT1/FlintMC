...
public class VersionedClientPlayer implements ClientPlayer {
  ...
  public String getBiome() {
    ...
    if (world != null) {
      String biomePath = world.func_241828_r()
              .func_243612_b(Registry.BIOME_KEY)
  ...
  public ChatComponent getDisplayNameAndUniqueId() {
    return this.minecraftComponentMapper.fromMinecraft((new StringTextComponent(""))
            .append(Minecraft.getInstance().player.getName())
            .appendString(" (")
  ...
  public boolean isOnGround() {
    return Minecraft.getInstance().player.isOnGround();
  }
  ...
  public boolean canHarvestBlock(Object blockState) {
    return Minecraft.getInstance().player.func_234569_d_((BlockState) blockState);
  }
