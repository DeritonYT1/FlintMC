 ...
 * Represents a player
 */
public interface Player extends CooldownTracking {
   ...
   */
  boolean canAttackPlayer(Object player);
   ...
   *
   * @return The player skin profile.
   */
  PlayerSkinProfile getSkinProfile();

  /**
   * Invalidates all session-related things.
   * <br>
   * For Example, the {@link NetworkPlayerInfo}, {@link PlayerSkinProfile} etc.
   */
  void invalidate();
