...
public interface ImageRenderer {
  ...
  /**
   * Binds the given texture location to be used for {@link #drawFullImage(float, float, int,
   * Object, float, float, float, float, int, int, int, int)}  and {@link #drawPartImage(float,
   * float, float, float, int, Object, float, float, float, float, float, float, int, int, int,
   * int)}.
   *
